        ...
        if (styleArray.contains(styleSelected)) {
            ...
            case "Reggae":
                GeneratorManager.sharedInstance.sendData(arr:
                   [0x1, 0x0, 0x0, 0x0, 0x11, 0x0, 0x0, 0x0, 0x11, 0x1, 0x0, 0x0, 0x0D, 0x0, 0x0, 0x0, 0x0A, 0x0, 0x0, 0x0]
                )
                break;
            case "Blues":
                GeneratorManager.sharedInstance.sendData(arr:
                    [0x1, 0x0, 0x0, 0x0, 0x11, 0x0, 0x0, 0x0, 0x11, 0x2, 0x0, 0x0, 0x0D, 0x0, 0x0, 0x0, 0x0A, 0x0, 0x0, 0x0]
                )
                break;
            case .none:
                break;
