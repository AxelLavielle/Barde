...
//
        ...
        if (styleArray.contains(styleSelected)) {
            ...
            case ("Add"), ("Ajouter"):
                GeneratorManager.sharedInstance.sendData(arr: [0x1, 0x0, 0x0, 0x0, 0x41, 0x0, 0x0, 0x0, 0x41, 0x2, 0x0, 0x0, 0x0D, 0x0, 0x0, 0x0, 0x0A, 0x0, 0x0, 0x0])
                break;
            case .none:
                break;
            case .some(_):
            ...
            case ("Add"), ("Ajouter"):
                GeneratorManager.sharedInstance.sendData(arr:
                    [0x1, 0x0, 0x0, 0x0, 0x41, 0x0, 0x0, 0x0, 0x41, 0x1, 0x0, 0x0, 0x0D, 0x0, 0x0, 0x0, 0x0A, 0x0, 0x0, 0x0]
                )
                break;
            case .none:
                break;
