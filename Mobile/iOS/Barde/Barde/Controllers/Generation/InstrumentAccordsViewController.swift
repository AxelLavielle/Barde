    ...
    @objc func buttonAction(_ button: CheckButton) {
        ...
        if (chordsArray.contains(chordsSelected)) {
            ...
            case "Basse acoustique":
                 GeneratorManager.sharedInstance.sendData(arr: [0x1, 0x0, 0x0, 0x0, 0x061, 0x0, 0x0, 0x0, 0x21, 0x0, 0x0, 0x0, 0x0D, 0x0, 0x0, 0x0, 0x0A, 0x0, 0x0, 0x0])
                break;
            case "Guitare nylon":
                 GeneratorManager.sharedInstance.sendData(arr: [0x1, 0x0, 0x0, 0x0, 0x061, 0x0, 0x0, 0x0, 0x19, 0x0, 0x0, 0x0, 0x0D, 0x0, 0x0, 0x0, 0x0A, 0x0, 0x0, 0x0])
                break;
            case .none:
                break;
            case .some(_):
            ...
            case "Saxophone":
                ...
                break;
            case "Basse acoustique":
                GeneratorManager.sharedInstance.sendData(arr: [0x1, 0x0, 0x0, 0x0, 0x021, 0x0, 0x0, 0x0, 0x21, 0x0, 0x0, 0x0, 0x0D, 0x0, 0x0, 0x0, 0x0A, 0x0, 0x0, 0x0])
                break;
            case "Guitare nylon":
                  GeneratorManager.sharedInstance.sendData(arr: [0x1, 0x0, 0x0, 0x0, 0x021, 0x0, 0x0, 0x0, 0x19, 0x0, 0x0, 0x0, 0x0D, 0x0, 0x0, 0x0, 0x0A, 0x0, 0x0, 0x0])
                break;
            case .none:
                break;
            case .some(_):
