...
class SlideBarListItemView @JvmOverloads constructor(
    ...
    fun setContent(slideModel: SlideModel) {
        ...
        slide_bar_list_item_view_min.text = slideModel.min.toString()
        slide_bar_list_item_view_max.text = slideModel.max.toString()
        slide_bar_list_item_view_value.text = mValue.toString()
