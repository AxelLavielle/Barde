...
class RegisterActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toRegister.setOnClickListener{
            doAsync {
                "http://10.0.2.2:3000/auth/register".httpPost(listOf("email" to register_email.text, "password" to register_password.text, "firstame" to register_firstname.text, "lastName" to register_lastname.text, "userName" to register_username.text)).responseString{ request, response, result ->
