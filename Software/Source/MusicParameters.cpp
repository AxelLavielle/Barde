...
{
	MusicParameters tmp;
	tmp._bpm = params.getBpm();
	tmp._instrumentsArpeggios = params.getInstrumentsArpeggios();
	tmp._instrumentsChords = params.getInstrumentsChords();
	tmp._instrumentsDrums = params.getInstrumentsDrums();
	return tmp;
}
